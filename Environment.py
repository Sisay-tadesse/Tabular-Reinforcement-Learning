...
class StochasticWindyGridworld:
    ...
    def reset(self):
        ...
        self.agent_location = np.array(self.start_location) # agent location= start location
        s = self._location_to_state(self.agent_location) 
        # takes the array as a coordinate, and using ravel_multi_index it finds the index from the coordinate
        return s 
    ...
    def _initialize_plot(self):
        ...
        # Add agent
        self.agent_circle = Circle(self.agent_location+0.5,0.3, facecolor='red')
